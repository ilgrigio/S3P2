...
// L'homepage che stai per creare sarà la vetrina dei prodotti disponibili, con qualche
// informazione per ciascun prodotto.
...
// ESERCIZIO 6: Aggiungi un campo testuale in cui l'utente può lasciare un commento su un
// prodotto (al momento non serve inserire nessuna "vera" funzionalità di POST/salvataggio!)
...
const sfondo = function () {
  ...
  color.style.backgroundColor = "rgb(20, 102, 170)";
};
sfondo();
